...
window.LB_I18N_SR = {
  strings: {
    ...
    // The Serbian date before this already ends in a period ("16. okt 2026.").
    ...
    "WHY ARE YOU LEAVING? (OPTIONAL)": "ZAŠTO ODLAZIŠ? (OPCIONO)",
    "Too expensive": "Preskupo je",
    "The ads aren't good enough": "Oglasi nisu dovoljno dobri",
    "No time to approve them": "Nemam vremena da ih odobravam",
    "Not seeing results": "Ne vidim rezultate",
    "Closing or pausing the business": "Zatvaram ili pauziram radnju",
    "Something else": "Nešto drugo",
    "Anything else we should know?": "Još nešto što bi trebalo da znamo?",
    "Never mind": "Ipak ne",
    "Payments": "Plaćanja",
